...
namespace Prg_Proccessy.SQLMODELS
{
    ...
    /// </summary>
    public class ANBARGRD_SUB1_MODEL : INotifyPropertyChanged, ICloneable, IEditableObject
    {
        // 1. متغیرهایی برای نگهداری نسخه پشتیبان و وضعیت ویرایش
        private ANBARGRD_SUB1_MODEL _backupData;
        ...
        public void BeginEdit()
        {
            ...
            if (!_isEditing)
            {
                _backupData = (ANBARGRD_SUB1_MODEL)this.MemberwiseClone();
                _isEditing = true;
            }
        }
        ...
        /// زمانی که کاربر کلید Escape را فشار می‌دهد.
        /// </summary>
