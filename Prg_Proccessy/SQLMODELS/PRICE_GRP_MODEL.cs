...
{
    public class PRICE_GRP_MODEL : INotifyPropertyChanged, IEditableObject, ICloneable
    {
        public PRICE_GRP_MODEL()
        {
        ...
        private PRICE_GRP_MODEL _backup;

        public void BeginEdit()
        {
            if (_isInEdit) return;
            _backup = (PRICE_GRP_MODEL)this.Clone();
            _isInEdit = true;
        }
