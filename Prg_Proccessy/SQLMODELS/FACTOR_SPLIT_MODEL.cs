namespace Prg_Proccessy.SQLMODELS
{
    public class FACTOR_SPLIT_MODEL
    {
        ...
        public long? date_h { get; set; }
        public long? ddf { get; set; }

        //FACTOR FROOSH:
        public double? SumOfM_NAGHD { get; set; }
        public double? SumOfMABL_VAR { get; set; }
        public double? SumOfMABL_HAV { get; set; }
        public double? SumOfMABL_HAZ { get; set; }
        public double? SumOfTAKHFIF { get; set; }
        ...
        public double? simbaa { get; set; }
        public double? jamch { get; set; }
        public double? SMBAA { get; set; }
