...
{
    /// <summary>
    /// Interaction logic for AK_MOGUDI_ANBAR_LIST_MERG.xaml
    /// </summary>
    public partial class AK_MOGUDI_ANBAR_LIST_MERG : Window
    {
        ...
        //Header Window End;
        #endregion
        public AK_MOGUDI_ANBAR_LIST_MERG(string _SQL_DATA_)
        {
            SQL_DATA = _SQL_DATA_;
            InitializeComponent();
        ...
        public ObservableCollection<MDS> AK_MOGUDI_MERG_DATA { get; set; } = new ObservableCollection<MDS>();
