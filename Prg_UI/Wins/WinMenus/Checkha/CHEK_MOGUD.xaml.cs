...
{
    /// <summary>
    /// Interaction logic for CHEK_MOGUD.xaml
    /// </summary>
    public partial class CHEK_MOGUD : Window
    {
        ...
        //Header Window End;
        #endregion
        public CHEK_MOGUD(string _sql_data)
        {
            SQL_DATA = _sql_data;
        ...
        public ObservableCollection<VDK> CHEK_MOGUD_DATA { get; set; } = new ObservableCollection<VDK>();
