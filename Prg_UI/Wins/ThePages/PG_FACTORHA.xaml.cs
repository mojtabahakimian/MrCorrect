...
namespace Wins.ThePages
{
    public partial class PG_FACTORHA : Page
    {
        ...
        private void Image_PreviewMouseDown_Direct(object sender, MouseButtonEventArgs e)
        {
            CL_MenuManager.OpenWinMenu(CL_MenuManager.WinNameType.HEAD_LST_KHAREED1_DIRECT, null /*DEFAULT OWNER MAIN*/);
        }
    }
}
